...
{
    fprintf(stdout, "Following child:%u\n", getpid());
    ...
    std::cout << "Child APP NAME: " << childApp << std::endl;
    //Set Pin's command line for child process
    INT pinArgc = 0;
    CHAR const * pinArgv[10];
    string pin_path = "/home/vignesh/Downloads/pin-3.11-97998-g7ecce2dac-gcc-linux";
    string tool_path = "/home/vignesh/Downloads/pin-3.11-97998-g7ecce2dac-gcc-linux/source/tools/ManualExamples/obj-intel64";
    string pin = "/home/vignesh/Downloads/pin-3.11-97998-g7ecce2dac-gcc-linux/pin";
    pinArgv[pinArgc++] = pin.c_str();
    pinArgv[pinArgc++] = "-follow_execv";
    pinArgv[pinArgc++] = "-t";
    string tool;
    if (childApp == "/home/vignesh/examples/multi_thread")
    	tool = "/home/vignesh/Downloads/pin-3.11-97998-g7ecce2dac-gcc-linux/source/tools/ManualExamples/obj-intel64/proccount1.so";
    else {
	tool = "/home/vignesh/Downloads/pin-3.11-97998-g7ecce2dac-gcc-linux/source/tools/ManualExamples/obj-intel64/proccount.so";
    }
    ...
    pinArgv[pinArgc++] = "--";
    //pinArgv[pinArgc++] = childApp.c_str();

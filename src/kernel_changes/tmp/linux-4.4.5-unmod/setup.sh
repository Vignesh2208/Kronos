...
sudo apt-get install git-core libncurses5 libncurses5-dev libelf-dev binutils-dev linux-source qt3-dev-tools libqt3-mt-dev fakeroot build-essential crash makedumpfile kernel-wedge kernel-package python-dev uml-utilities vtun autoconf autotools-dev automake lua5.2-dev flex bison bridge-utils cgroup-lite libcap-dev libssl-dev
